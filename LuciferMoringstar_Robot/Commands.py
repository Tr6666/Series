    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**🤕 ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴛᴀᴍɪʟʀᴏᴀʀs ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜsᴇ ᴍᴇ 🤕**",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("😈 ᴊᴏɪɴ ᴛᴀᴍɪʟʀᴏᴀʀs ᴄʜᴀɴɴᴇʟ 😈", url=invite_link.invite_link)
                            ],
                            [
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('📽️ ᴍᴏʀᴇ sᴇʀɪᴇs 📽️', url=f'{TUTORIAL}')
                    ]
                    ]
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('🎬 ᴍᴏʀᴇ ᴍᴏᴠɪᴇs 🎬', url=f'{TUTORIAL}')
        ]
        ]
